              ...
              <div class="row">
                <div class="col-md-8 offset-md-2">
                  ...
                  <h5 v-if="yaInvirtio" class="invertido">
                    Dinero invertido: ${{ inversion.dineroInvertido }}
                  </h5>
                  <div class="row">
                    <div class="col-md-6">
                      <RouteterLink @click="contactarCreador(idea)">
                        <button class="btn btn-info">Contactar Creador</button>
                      </RouteterLink>
                    </div>
...
const getInversiones = async () => {
  const inversion = (await inversionService.obtenerInversion(idea.id, user.id))
    .data;
